// frontend/src/components/WaterTanksCalculator.js
import React, { useState } from "react";
import axios from "axios";

function WaterTanksCalculator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/calculate/water-tanks",
        {
          ...inputs,
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">Water Tanks Quantity Takeoff</h2>
      <form
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
          ...
          <table className="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              ...
              <tr>
                <td className="border border-gray-300 p-2">Formwork to tank</td>
...
export default WaterTanksCalculator;
