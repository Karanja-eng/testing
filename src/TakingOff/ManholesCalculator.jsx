// frontend/src/components/ManholesCalculator.js
import React, { useState } from "react";
import axios from "axios";

function ManholesCalculator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/calculate/manholes",
        {
          ...inputs,
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">Manholes Quantity Takeoff</h2>
      <form
          ...
          <table className="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  π x {(inputs.diameter / 2).toFixed(2)}² x {inputs.depth}
                </td>
                <td className="border border-gray-300 p-2">
              ...
              <tr>
                <td className="border border-gray-300 p-2">
                  Formwork to manhole walls
                </td>
                <td className="border border-gray-300 p-2">1</td>
                <td className="border border-gray-300 p-2">
                  π x {inputs.diameter} x {inputs.depth}
                </td>
                <td className="border border-gray-300 p-2">
...
export default ManholesCalculator;
