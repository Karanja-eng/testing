// frontend/src/components/FoundationCalculator.js
// Example for Foundation (adapt others similarly)
...
function FoundationCalculator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/calculate/foundation",
        {
          ...inputs,
          length: parseFloat(inputs.length),
          width: parseFloat(inputs.width),
          depth: parseFloat(inputs.depth),
          trench_width: parseFloat(inputs.trench_width),
        }
      );
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">Foundation Quantity Takeoff</h2>
      <form
          ...
          <table className="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  {inputs.length} x {inputs.trench_width} x {inputs.depth}
                </td>
                <td className="border border-gray-300 p-2">
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  {results.vol_concrete.toFixed(2)} m³
                </td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-2">
