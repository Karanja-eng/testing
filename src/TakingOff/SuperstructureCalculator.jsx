// frontend/src/components/SuperstructureCalculator.js
import React, { useState } from "react";
import axios from "axios";

function SuperstructureCalculator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/calculate/superstructure",
        {
          ...inputs,
      ...
      {results && (
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
          ...
          <table className="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 p-2">Concrete in slab</td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  {(
                    parseFloat(inputs.length) + parseFloat(inputs.width)
                  ).toFixed(2)}{" "}
                  x {inputs.thickness}
                </td>
                <td className="border border-gray-300 p-2">
...
export default SuperstructureCalculator;
