// frontend/src/components/RetainingWallsCalculator.js
import React, { useState } from "react";
import axios from "axios";

function RetainingWallsCalculator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/calculate/retaining-walls",
        {
          ...inputs,
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">
        Retaining Walls Quantity Takeoff
      </h2>
      <form
          ...
          <table className="w-full border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  {inputs.length} x {inputs.height} x {inputs.thickness}
                </td>
                <td className="border border-gray-300 p-2">
...
export default RetainingWallsCalculator;
